...
public class SelectMovieTargets {
    ...
    public static Target FIRST_MOVIE = Target.the("First movie").located(By.xpath("(//div[@class='jsx-2391151467 item-wrap'])[3]"));
    ...
    public static Target ROOM = Target.the("Room").located(By.xpath("//div[@class='jsx-2338673825 room__screen']"));
    public static Target SEAT_SELECTED = Target.the("Room").located(By.xpath("//*[@id=\"map\"]/div/div[81]/button"));
