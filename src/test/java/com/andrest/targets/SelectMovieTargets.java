...
public class SelectMovieTargets {
    ...
    public static Target ROOM = Target.the("Room").located(By.xpath("//div[contains(@class,'jsx-30724968 room__screen')]"));
    public static Target SEAT_SELECTED = Target.the("Room").located(By.xpath("(//button[contains(@class,'jsx-580933617')])[310]"));
